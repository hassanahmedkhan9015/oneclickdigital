    ...
    <>
      ...
      {/* <div className="flex items-center justify-center mt-28">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full bg-orange-500 text-white p-2 rounded-md hover:bg-orange-600 transition-all"
          >
            Register
          </button>
          ...
          <button
            onClick={() => signIn("google", { callbackUrl: "/" })}
            className=" border w-full  p-2 rounded-md hover:bg-gray-100 transition-all mt-3 flex items-center gap-3 justify-center"
          >
            <span>
              <Image src={Google} alt="Google-icon" />
            </span>
